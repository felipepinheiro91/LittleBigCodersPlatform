...
class PlatformTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.material = Material.objects.create(title='Prova', type='quiz')
        self.material.chapters.add(self.chapter)
    ...
    def test_student_access_and_hidden_answers(self):
        ...
        key = Material.objects.create(title='Gabarito', type='answer_key')
        key.chapters.add(self.chapter)
    ...
    def test_admin_creates_challenge_directly_in_chapter(self):
        ...
        self.assertEqual(list(challenge.material.chapters.all()), [self.chapter])
    ...
    def test_filters_change_report(self):
        ...
        material = Material.objects.create(title='Outra prova', type='quiz')
        material.chapters.add(second)
